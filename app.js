angular.module('demoApp', ["controllers", "forceng"])
    ...
    .run(function ($window, force) {
        ...
        force.init({
            ...
            oauthRedirectURL: 'http://samforceng.herokuapp.com/oauthcallback.html',
            ...
            //proxyURL: 'https://samforceng.herokuapp.com/' /* Node.js hosted proxy provided as a sample for development only https://github.com/ccoenraets/cors-proxy */
